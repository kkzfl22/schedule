 ...
 * @date 2019/08/31
 */
public class EtlScheduleTaskThreadPool {
     ...
     * 进行任务调度的线程池对象
     */
    public static final EtlScheduleTaskThreadPool INSTANCE = new EtlScheduleTaskThreadPool();
     ...
     */
    private ThreadFactory factory = new EtlScheduleTaskThreadFactory();
