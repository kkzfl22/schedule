...
@Service
@Slf4j
public class DcTaskInfoApplicationService {
    ...
    public DomainPage<List<DcTaskInfoDO>> queryPage(DomainPage<DcTaskInfoDO> pageReq){
        DomainPage<List<DcTaskInfoDO>> pageResult = domainService.queryPage(pageReq);
        return pageResult;
    }
    ...
    public DcTaskInfoDO detail(DcTaskInfoDO param){
        DcTaskInfoDO queryReturn = domainService.detail(param);
        return queryReturn;
    }
